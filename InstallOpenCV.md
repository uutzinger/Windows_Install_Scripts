...
Add gstreamer to your search path.
```
C:\gstreamer\1.0\x86_64\bin
...
copy  vC:\Program Files (x86)\IntelSWTools\compilers_and_libraries\windows\mpi\intel64\bin\release\*" C:\opencv\opencv_redist /y
